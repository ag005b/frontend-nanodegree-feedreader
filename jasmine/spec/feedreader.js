...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
        ...
        it('contains a URL & the URL is not empty', function() {
         ...
         */
         ...
         it('contains a NAME & the NAME is not empty', function() {
            allFeeds.forEach(function(feed) {
    ...
    describe('Initial Entries', function() {
         ...
         */
         ...
         it('ensures when the loadFeed function is called and completes its work', function() {
